...
<div class="container bg-white mt-5 pt-3 ps-3 pb-3 pe-3 rounded-3 shadow-lg">
    ...
    <hr>
    <input class="form-control" type="text" size="25" placeholder="Buscar" name="buscar">
    <hr>
    </form>
...
<table class="table table-bordered table-striped table-hover" width="500px">
    ...
    ?>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-danger" href="controllers/deletar.php?id_aluno=<?php echo $exibe[0] ?>">Excluir</a>
            </td>
        </tr>
